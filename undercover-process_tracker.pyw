...
def save_to_file(process_list, filename):
    ...
    # Dosya yolunu "log" klasörü içine ayarla
    ...
    with open(filepath, 'w', encoding='utf-8') as file:
        for process in process_list:
            ...
            file.write(f"Baslatilan Tarih/Saat: {process['create_time']}\n\n")
...
def main():
    ...
    while True:
        ...
        if closed_processes:
            ...
            files = {'file': open(os.path.join("log", 'kapatilan_islemler.txt'), 'rb')}
        ...
        if new_processes:
            ...
            files = {'file': open(os.path.join("log", 'acilan_islemler.txt'), 'rb')}
